...
function updateBP_NORTEMG() {
  ...
  // Nome da planilha
  const SHEET_BP_NORTEMG = "BP NORTE DE MINAS";

  // 💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙 SLIDE 142 💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙💙

  const slideIndex142 = 141; // Índice do slide (baseado em 0)

  try {
    // Acessar a planilha e os dados
    var spreadsheet = SpreadsheetApp.openById(SHEETS_ID);
    var sheet = spreadsheet.getSheetByName(SHEET_BP_NORTEMG);

    // Acessar a apresentação e o slide
    var presentation = SlidesApp.openById(SLIDES_ID);
    var slide142 = presentation.getSlides()[slideIndex142];
    ...
    slide142.getShapes()[153].getText().setText(PN_TOTAL); // Total
    slide142.getShapes()[154].getText().setText(DATAMOUNTH); // Período
    ...
    slide142.getShapes()[173].getText().setText(PN2_TOTAL); // Total
    ...
    slide142.getShapes()[176].getText().setText(PA_TOTAL); // Total
    // slide142.getShapes()[##].getText().setText(PA_SUSPENDED_PERCENTAGE + "%"); // Suspensos
    // slide142.getShapes()[##].getText().setText(PA_INPROGRESS_PERCENTAGE + "%"); // Suspensos
    ...
    // slide142.getShapes()[204].getText().setText(PEP_META_NOVOS + "%"); // PEP - Meta - Projetos Novos
    ...
    slide142.getShapes()[200].setHeight(newHeight_PEP_NOVOS); // Ajustar a altura da barra de progresso - Projetos Novos
    ...
    // slide142.getShapes()[223].getText().setText(PEP_META_ANTIGOS + "%"); // PEP - Meta - Projetos Antigos
    ...
    slide142.getShapes()[208].setHeight(newHeight_PEP_ANTIGOS); // Ajustar a altura da barra de progresso - Projetos Antigos
    ...
    // slide142.getShapes()[144].getText().setText(CONFORMIDADE_META + "%"); // Conformidade - META
    slide142
      .getShapes()[143]
      .getText()
      .getTextStyle()
    ...
    slide142.getShapes()[67].setHeight(newHeight_CRONOGRAMA); // Ajustar a altura da barra de progresso
    slide142.getShapes()[67].getFill().setSolidFill(BARRA_CRONOGRAMA); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[65].setHeight(newHeight_SINTONIA); // Ajustar a altura da barra de progresso
    slide142.getShapes()[65].getFill().setSolidFill(BARRA_SINTONIA); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[63].setHeight(newHeight_APONTAMENTO_HORAS); // Ajustar a altura da barra de progresso
    slide142.getShapes()[63].getFill().setSolidFill(BARRA_APONTAMENTOH); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[84].setHeight(newHeight_ESCOPO); // Ajustar a altura da barra de progresso
    slide142.getShapes()[84].getFill().setSolidFill(BARRA_ESCOPO); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[82].setHeight(newHeight_SIMULACAO); // Ajustar a altura da barra de progresso
    slide142.getShapes()[82].getFill().setSolidFill(BARRA_SIMULACAO); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[80].setHeight(newHeight_KICKOFF); // Ajustar a altura da barra de progresso
    slide142.getShapes()[80].getFill().setSolidFill(BARRA_KICKOFF); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[86].setHeight(newHeight_ENCERRAMENTO); // Ajustar a altura da barra de progresso
    slide142.getShapes()[86].getFill().setSolidFill(BARRA_ENCERRAMENTO); // Aplicar a cor sólida ao preenchimento
    ...
    slide142.getShapes()[37].getText().setText(CLUSTER_500_A); // Cluster <= 500H (ANTIGOS)
    slide142.getShapes()[163].getText().setText(CLUSTER_1000_A); // Cluster <= 1000H (ANTIGOS)
    slide142.getShapes()[166].getText().setText(CLUSTER_1500_A); // Cluster <= 1500H (ANTIGOS)
    slide142.getShapes()[169].getText().setText(CLUSTER_1500MAIS_A); // Cluster > 1500H (ANTIGOS)
    slide142.getShapes()[14].getText().setText(CLUSTER_TOTAL_A); // Cluster TOTAL (ANTIGOS)
    ...
    slide142.getShapes()[50].getText().setText(CLUSTER_500_N); // Cluster <= 500H (NOVOS)
    slide142.getShapes()[164].getText().setText(CLUSTER_1000_N); // Cluster <= 1000H (NOVOS)
    slide142.getShapes()[167].getText().setText(CLUSTER_1500_N); // Cluster <= 1500H (NOVOS)
    slide142.getShapes()[170].getText().setText(CLUSTER_1500MAIS_N); // Cluster > 1500H (NOVOS)
    slide142.getShapes()[19].getText().setText(CLUSTER_TOTAL_N); // Cluster TOTAL (NOVOS)
    ...
    // slide142.getShapes()[198].getText().setText(DMP_META + "%"); // DMP - Meta
    // slide142.getShapes()[177].getText().setText(DMP_DESCRITIVO); // DMP - Texto descritivo abaixo da box
    ...
    slide142.getShapes()[196].setHeight(newHeight_DMP); // Ajustar a altura da barra de progresso
    slide142.getShapes()[196].getFill().setSolidFill(BARRA_DMP); // Aplicar a cor sólida ao preenchimento
    ...
    slide143.getShapes()[24].getText().setText(DATAMOUNTH2); // Período
    ...
    slide143.getShapes()[4].setHeight(newHeight_SAT_PN); // Ajustar a altura da barra de progresso
    slide143.getShapes()[4].getFill().setSolidFill(BARRA_SAT_NOVOS); // Aplicar a cor sólida ao preenchimento
    ...
    slide143.getShapes()[8].setHeight(newHeight_SAT_PA); // Ajustar a altura da barra de progresso
    slide143.getShapes()[8].getFill().setSolidFill(BARRA_SAT_ANTIGOS); // Aplicar a cor sólida ao preenchimento
    ...
    slide143.getShapes()[13].getText().setText(OFENSOR_01); // Item 1 da lista de Ofensores
    slide143.getShapes()[14].getText().setText(OFENSOR_02); // Item 2 da lista de Ofensores
    slide143.getShapes()[16].getText().setText(OFENSOR_03); // Item 3 da lista de Ofensores
    slide143.getShapes()[18].getText().setText(OFENSOR_04); // Item 4 da lista de Ofensores
    slide143.getShapes()[20].getText().setText(OFENSOR_05); // Item 5 da lista de Ofensores
    ...
    var DATAMOUNTH2 = sheet.getRange("M40").getValue();
    slide144.getShapes()[37].getText().setText(DATAMOUNTH2); // Período

    // Plano de ação - caixas de texto
    var PLAN_AC_EA = sheet.getRange("B140").getValue();
    var PLAN_AC_ENC = sheet.getRange("B141").getValue();

    slide144.getShapes()[33].getText().setText(PLAN_AC_EA); // Plano de ação - Em Aberto
    slide144.getShapes()[36].getText().setText(PLAN_AC_ENC); // Plano de ação - Encerrados

    // Reclamações - caixa de texto
    var RECL_AC_EA = sheet.getRange("B150").getValue();
    var TOTAL_PORTF = sheet.getRange("B151").getValue();

    slide144.getShapes()[5].getText().setText(RECL_AC_EA); // // Reclamações - Em Aberto
    slide144.getShapes()[8].getText().setText(RECL_AC_EA); // // Reclamações - Em Aberto
    slide144.getShapes()[3].getText().setText(TOTAL_PORTF); // // Reclamações - Total do Portfólio
    ...
    slide144.getShapes()[18].getText().setText(VLR_MMR_Formatado); // MMR - Total
    ...
    slide144.getShapes()[9].getText().setText(CL1); // Clientes / Unidades (1)
    slide144.getShapes()[10].getText().setText(CL2); // Clientes / Unidades (2)
    slide144.getShapes()[12].getText().setText(CL3); // Clientes / Unidades (3)
    slide144.getShapes()[14].getText().setText(CL4); // Clientes / Unidades (4)
    slide144.getShapes()[16].getText().setText(CL5); // Clientes / Unidades (5)
    ...
    slide145.getShapes()[12].getText().setText(DATAMOUNTH3); // Período

    // Considerações finais
    var OBS_CONSID = sheet.getRange("B195").getValue();
    slide145.getShapes()[10].getText().setText(OBS_CONSID); // Box de dados a preencher - Considerações

    // Pontos de atenção
    var PONTOS_ATENC = sheet.getRange("B204").getValue();
    slide145.getShapes()[11].getText().setText(PONTOS_ATENC); // Box de dados a preencher - Pontos de atenção
    ...
    slide145.getShapes()[13].getText().setText(UNID_1); // Box de dados a preencher - UNIDADE 1
    slide145.getShapes()[14].getText().setText(UNID_2); // Box de dados a preencher - UNIDADE 2
    slide145.getShapes()[15].getText().setText(UNID_3); // Box de dados a preencher - UNIDADE 3
    slide145.getShapes()[16].getText().setText(UNID_4); // Box de dados a preencher - UNIDADE 4
    slide145.getShapes()[17].getText().setText(UNID_5); // Box de dados a preencher - UNIDADE 5
    ...
    slide145.getShapes()[8].getText().setText(PLAN_AC_UNID_1); // Box de dados a preencher - Plano de ação 1
    slide145.getShapes()[3].getText().setText(PLAN_AC_UNID_2); // Box de dados a preencher - Plano de ação 2
    slide145.getShapes()[18].getText().setText(PLAN_AC_UNID_3); // Box de dados a preencher - Plano de ação 3
    slide145.getShapes()[4].getText().setText(PLAN_AC_UNID_4); // Box de dados a preencher - Plano de ação 4
    slide145.getShapes()[5].getText().setText(PLAN_AC_UNID_5); // Box de dados a preencher - Plano de ação 5
  } catch (e) {
