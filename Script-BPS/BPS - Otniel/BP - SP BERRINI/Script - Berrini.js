...
// Gráfico 1
function createChartBerrini1() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_BP_BERRINI);
  ...
  insertChartBerrini(chart);
}

// Gráfico 2
function createChartBerrini2() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_BP_BERRINI);
...
function insertChartBerrini(chart) {
  if (chart) { 
    const slides = SlidesApp.openById(SLIDES_ID);
    const slide = slides.getSlides()[slideIndex71];
...
function updateBP_BERRINI() {
  ...
  try {
    ...
    slide71.getShapes()[147].getText().setText(PN_INPROGRESS_PERCENTAGE_Formatado + "%"); // Em andamento
    slide71.getShapes()[150].getText().setText(PN_SUSPENDED_PERCENTAGE_Formatado + "%"); // Suspensos
    slide71.getShapes()[153].getText().setText(PN_TOTAL); // Total
    slide71.getShapes()[154].getText().setText(DATAMOUNTH); // Período
  ...
  // Dados da Planilha - Colocar a célula da planilha
    ...
    slide71.getShapes()[40].getText().setText(PN2_INPROGRESS_PERCENTAGE_Formatado + "%"); // Em andamento
    slide71.getShapes()[43].getText().setText(PN2_SUSPENDED_PERCENTAGE_Formatado + "%"); // Suspensos
    slide71.getShapes()[173].getText().setText(PN2_TOTAL); // Total
   ...
   // Dados da Planilha - Colocar a célula da planilha
    ...
    slide71.getShapes()[46].getText().setText(PA_INPROGRESS_PERCENTAGE_Formatado + "%"); // Em andamento
    slide71.getShapes()[49].getText().setText(PA_SUSPENDED_PERCENTAGE_Formatado + "%"); // Suspensos
    slide71.getShapes()[176].getText().setText(PA_TOTAL); // Total
    // slide71.getShapes()[##].getText().setText(PA_SUSPENDED_PERCENTAGE + "%"); // Suspensos
    // slide71.getShapes()[##].getText().setText(PA_INPROGRESS_PERCENTAGE + "%"); // Suspensos
    ...
    // ⭐ PROJETOS CONCLUÍDOS 
      ...
      slide71.getShapes()[22].getText().setText(PC_FASE1 + " - Fase 1"); // Projetos Concluídos - 1ª Fase 
      slide71.getShapes()[155].getText().setText(PC_FASE2 + " -  Fase 2"); // Projetos Concluídos - 2ª Fase 
      slide71.getShapes()[20].getText().setText(PC_TOTAL + " TOTAL"); // Projetos Concluídos - Total
    ...
    // ⭐ PEP ⭐ 
      ...
      var PEP_META_NOVOS = sheet.getRange('B51').getValue();
        ...
        slide71.getShapes()[203].getText().setText(PEP_ATINGIDO_NOVOS + "%"); // PEP - Atingido - Projetos Novos
        // slide71.getShapes()[204].getText().setText(PEP_META_NOVOS + "%"); // PEP - Meta - Projetos Novos
      ...
      slide71.getShapes()[200].setHeight(newHeight_PEP_NOVOS); // Ajustar a altura da barra de progresso - Projetos Novos
      ...
      var PEP_META_ANTIGOS = sheet.getRange('B52').getValue();
        ...
        slide71.getShapes()[222].getText().setText(PEP_ATINGIDO_ANTIGOS + "%"); // PEP - Atingido - Projetos Antigos
        // slide71.getShapes()[223].getText().setText(PEP_META_ANTIGOS + "%"); // PEP - Meta - Projetos Antigos
      ...
      slide71.getShapes()[208].setHeight(newHeight_PEP_ANTIGOS); // Ajustar a altura da barra de progresso - Projetos Antigos
    ...
    // ⭐ CONFORMIDADE DE PROJETOS ⭐ 
      ...
      var CONFORMIDADE_COR_FONTE = sheet.getRange('L62').getValue();
        ...
        slide71.getShapes()[143].getText().setText(CONFORMIDADE_ATINGIDO + "%"); // Conformidade - ATINGIDO
        // slide71.getShapes()[144].getText().setText(CONFORMIDADE_META + "%"); // Conformidade - META
        slide71.getShapes()[143].getText().getTextStyle().setForegroundColor(CONFORMIDADE_COR_FONTE); // Conformidade: Meta Atingida - Cor da fonte
      ...
      var BARRA_ENCERRAMENTO = sheet.getRange('K68').getValue();
        ...
        slide71.getShapes()[68].getText().setText(CRONOGRAMA + "%"); // Conformidade - Cronograma
        slide71.getShapes()[66].getText().setText(SINTONIA + "%"); // Conformidade - Sintonia
        slide71.getShapes()[64].getText().setText(APONTAMENTO_HORAS + "%"); // Conformidade - Apontamento de horas
        slide71.getShapes()[85].getText().setText(ESCOPO + "%"); // Conformidade - Escopo
        slide71.getShapes()[83].getText().setText(SIMULACAO + "%"); // Conformidade - Simulação
        slide71.getShapes()[81].getText().setText(KICKOFF + "%"); // Conformidade - Kickoff
        slide71.getShapes()[87].getText().setText(ENCERRAMENTO + "%"); // Conformidade - Encerramento
      ...
      slide71.getShapes()[67].setHeight(newHeight_CRONOGRAMA); // Ajustar a altura da barra de progresso
      slide71.getShapes()[67].getFill().setSolidFill(BARRA_CRONOGRAMA); // Aplicar a cor sólida ao preenchimento
      ...
      slide71.getShapes()[65].setHeight(newHeight_SINTONIA); // Ajustar a altura da barra de progresso
      slide71.getShapes()[65].getFill().setSolidFill(BARRA_SINTONIA); // Aplicar a cor sólida ao preenchimento
      ...
      slide71.getShapes()[63].setHeight(newHeight_APONTAMENTO_HORAS); // Ajustar a altura da barra de progresso
      slide71.getShapes()[63].getFill().setSolidFill(BARRA_APONTAMENTOH); // Aplicar a cor sólida ao preenchimento
      ...
      slide71.getShapes()[84].setHeight(newHeight_ESCOPO); // Ajustar a altura da barra de progresso
      slide71.getShapes()[84].getFill().setSolidFill(BARRA_ESCOPO); // Aplicar a cor sólida ao preenchimento
      ...
      slide71.getShapes()[82].setHeight(newHeight_SIMULACAO); // Ajustar a altura da barra de progresso
      slide71.getShapes()[82].getFill().setSolidFill(BARRA_SIMULACAO); // Aplicar a cor sólida ao preenchimento
      ...
      slide71.getShapes()[80].setHeight(newHeight_KICKOFF); // Ajustar a altura da barra de progresso
      slide71.getShapes()[80].getFill().setSolidFill(BARRA_KICKOFF); // Aplicar a cor sólida ao preenchimento
      ...
      slide71.getShapes()[86].setHeight(newHeight_ENCERRAMENTO); // Ajustar a altura da barra de progresso
      slide71.getShapes()[86].getFill().setSolidFill(BARRA_ENCERRAMENTO); // Aplicar a cor sólida ao preenchimento
    ...
    // ⭐ PROJETOS CONCLUÍDOS - CLUSTER ⭐
      ...
      slide71.getShapes()[37].getText().setText(CLUSTER_500_A); // Cluster <= 500H (ANTIGOS)
      slide71.getShapes()[163].getText().setText(CLUSTER_1000_A); // Cluster <= 1000H (ANTIGOS)
      slide71.getShapes()[166].getText().setText(CLUSTER_1500_A); // Cluster <= 1500H (ANTIGOS)
      slide71.getShapes()[169].getText().setText(CLUSTER_1500MAIS_A); // Cluster > 1500H (ANTIGOS)
      slide71.getShapes()[14].getText().setText(CLUSTER_TOTAL_A); // Cluster TOTAL (ANTIGOS)
      ...
      slide71.getShapes()[50].getText().setText(CLUSTER_500_N); // Cluster <= 500H (NOVOS)
      slide71.getShapes()[164].getText().setText(CLUSTER_1000_N); // Cluster <= 1000H (NOVOS)
      slide71.getShapes()[167].getText().setText(CLUSTER_1500_N); // Cluster <= 1500H (NOVOS)
      slide71.getShapes()[170].getText().setText(CLUSTER_1500MAIS_N); // Cluster > 1500H (NOVOS)
      slide71.getShapes()[19].getText().setText(CLUSTER_TOTAL_N); // Cluster TOTAL (NOVOS)
    ...
    // ⭐ DMP ⭐
      ...
      var DMP_DESCRITIVO = sheet.getRange('B94:F94').getValue();
        ...
        // Ajustar os valores contidos dentro das barras
        slide71.getShapes()[195].getText().setText(DMP_ATINGIDO + "%"); // DMP - Atingido
        // slide71.getShapes()[198].getText().setText(DMP_META + "%"); // DMP - Meta
        // slide71.getShapes()[177].getText().setText(DMP_DESCRITIVO); // DMP - Texto descritivo abaixo da box
      ...
      slide71.getShapes()[196].setHeight(newHeight_DMP); // Ajustar a altura da barra de progresso
      slide71.getShapes()[196].getFill().setSolidFill(BARRA_DMP); // Aplicar a cor sólida ao preenchimento
    ...
    var slide72 = presentation.getSlides()[slideIndex72];
      ...
      slide72.getShapes()[24].getText().setText(DATAMOUNTH2); // Período
      ...
      var BARRA_SAT_ANTIGOS = sheet.getRange('K109').getValue();
        ...
        slide72.getShapes()[5].getText().setText(SATISFAÇAO_ATINGIDO_PN + "%"); // SATISFAÇÃO - ATINGIDO
        // slide.getShapes()[6].getText().setText(SATISFAÇAO_META_PN + "%"); // SATISFAÇÃO - META
        slide72.getShapes()[5].getText().getTextStyle().setForegroundColor(SATISFAÇAO_COR_FONTE_PN); // Satisfação: Atingido - Cor da fonte

        // Ajustar os valores  - SATISFAÇÃO DE PROJETOS ANTIGOS
        slide72.getShapes()[9].getText().setText(SATISFAÇAO_ATINGIDO_PA + "%"); // SATISFAÇÃO - ATINGIDO
        // slide.getShapes()[10].getText().setText(SATISFAÇAO_META_PA + "%"); // SATISFAÇÃO - META
        slide72.getShapes()[9].getText().getTextStyle().setForegroundColor(SATISFAÇAO_COR_FONTE_PA); // Satisfação: Meta - Cor da fonte
      ...
      slide72.getShapes()[4].setHeight(newHeight_SAT_PN); // Ajustar a altura da barra de progresso
      slide72.getShapes()[4].getFill().setSolidFill(BARRA_SAT_NOVOS); // Aplicar a cor sólida ao preenchimento
      ...
      slide72.getShapes()[8].setHeight(newHeight_SAT_PA); // Ajustar a altura da barra de progresso
      slide72.getShapes()[8].getFill().setSolidFill(BARRA_SAT_ANTIGOS); // Aplicar a cor sólida ao preenchimento
    ...
    // Ofensores - Lista
      ...
      slide72.getShapes()[13].getText().setText(OFENSOR_01); // Item 1 da lista de Ofensores
      slide72.getShapes()[14].getText().setText(OFENSOR_02); // Item 2 da lista de Ofensores
      slide72.getShapes()[16].getText().setText(OFENSOR_03); // Item 3 da lista de Ofensores
      slide72.getShapes()[18].getText().setText(OFENSOR_04); // Item 4 da lista de Ofensores
      slide72.getShapes()[20].getText().setText(OFENSOR_05); // Item 5 da lista de Ofensores
    ...
    var DATAMOUNTH2 = sheet.getRange('C38').getValue();
    slide73.getShapes()[37].getText().setText(DATAMOUNTH2); // Período

    // Plano de ação - caixas de texto
      var PLAN_AC_EA = sheet.getRange('B140').getValue();
      var PLAN_AC_ENC = sheet.getRange('B141').getValue();

      slide73.getShapes()[33].getText().setText(PLAN_AC_EA); // Plano de ação - Em Aberto
      slide73.getShapes()[36].getText().setText(PLAN_AC_ENC); // Plano de ação - Encerrados

    // Reclamações - caixa de texto
      var RECL_AC_EA = sheet.getRange('B150').getValue();
      var TOTAL_PORTF = sheet.getRange('B151').getValue();

      slide73.getShapes()[5].getText().setText(RECL_AC_EA); // // Reclamações - Em Aberto
      slide73.getShapes()[8].getText().setText(RECL_AC_EA); // // Reclamações - Em Aberto
      slide73.getShapes()[3].getText().setText(TOTAL_PORTF); // // Reclamações - Total do Portfólio
      ...
      slide73.getShapes()[18].getText().setText(VLR_MMR_Formatado); // MMR - Total
      ...
      slide73.getShapes()[9].getText().setText(CL1); // Clientes / Unidades (1)
      slide73.getShapes()[10].getText().setText(CL2); // Clientes / Unidades (2)
      slide73.getShapes()[12].getText().setText(CL3); // Clientes / Unidades (3)
      slide73.getShapes()[14].getText().setText(CL4); // Clientes / Unidades (4)
      slide73.getShapes()[16].getText().setText(CL5); // Clientes / Unidades (5)
      ...
      slide73.getShapes()[23].getText().setText(CL1_MMR + " mil"); // MMR por Cliente / Unidade (1)
      slide73.getShapes()[24].getText().setText(CL2_MMR + " mil"); // MMR por Cliente / Unidade (2)
      slide73.getShapes()[25].getText().setText(CL3_MMR + " mil"); // MMR por Cliente / Unidade (3)
      slide73.getShapes()[26].getText().setText(CL4_MMR + " mil"); // MMR por Cliente / Unidade (4)
      slide73.getShapes()[27].getText().setText(CL5_MMR + " mil"); // MMR por Cliente / Unidade (5)

      // 💚💚💚💚💚💚💚💚💚💚 SLIDE 74 💜💜💜💜💜💜💜💜💜💜


        const slideIndex74 = 73; // Índice do slide (baseado em 0)

    // Acessar a apresentação e o slide
    var presentation = SlidesApp.openById(SLIDES_ID);
    var slide74 = presentation.getSlides()[slideIndex74];

    // Dados da planilha para o slide
    var DATAMOUNTH3 = sheet.getRange('C38').getValue();
    slide74.getShapes()[12].getText().setText(DATAMOUNTH3); // Período


    // Considerações finais
      var OBS_CONSID = sheet.getRange('B195').getValue();
      slide74.getShapes()[10].getText().setText(OBS_CONSID); // Box de dados a preencher - Considerações


    // Pontos de atenção
      var PONTOS_ATENC = sheet.getRange('B204').getValue();
      slide74.getShapes()[11].getText().setText(PONTOS_ATENC); // Box de dados a preencher - Pontos de atenção
    ...
    // Plano de ação - UNIDADES
      ...
      slide74.getShapes()[13].getText().setText(UNID_1); // Box de dados a preencher - UNIDADE 1
      slide74.getShapes()[14].getText().setText(UNID_2); // Box de dados a preencher - UNIDADE 2
      slide74.getShapes()[15].getText().setText(UNID_3); // Box de dados a preencher - UNIDADE 3
      slide74.getShapes()[16].getText().setText(UNID_4); // Box de dados a preencher - UNIDADE 4
      slide74.getShapes()[17].getText().setText(UNID_5); // Box de dados a preencher - UNIDADE 5
      ...
      slide74.getShapes()[8].getText().setText(PLAN_AC_UNID_1); // Box de dados a preencher - Plano de ação 1
      slide74.getShapes()[3].getText().setText(PLAN_AC_UNID_2); // Box de dados a preencher - Plano de ação 2
      slide74.getShapes()[18].getText().setText(PLAN_AC_UNID_3); // Box de dados a preencher - Plano de ação 3
      slide74.getShapes()[4].getText().setText(PLAN_AC_UNID_4); // Box de dados a preencher - Plano de ação 4
      slide74.getShapes()[5].getText().setText(PLAN_AC_UNID_5); // Box de dados a preencher - Plano de ação 5
