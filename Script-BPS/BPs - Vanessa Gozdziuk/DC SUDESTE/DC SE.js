...
// Gráfico 1
function createChartSE() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_DC_SE);
  ...
  insertChartIntoSlideSE(chart);
}

// Gráfico 2
function createChartSE2() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_DC_SE);
...
function insertChartIntoSlideSE(chart) {
  if (chart) {
    const slides = SlidesApp.openById(SLIDES_ID);
    const slide = slides.getSlides()[slideIndex14];
...
function updateLastThreeChartsSE() {
  const slides = SlidesApp.openById(SLIDES_ID);
  const slide = slides.getSlides()[slideIndex14];
  ...
  if (images.length >= 3) {
    ...
    const sheet =
      SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_DC_SE);
...
function updateImageSE(slide, image, chart) {
  const blob = chart.getAs("image/png");
...
function updateDC_SUDESTE() {
  ...
  try {
    ...
    var PN_SUSPENDED_PERCENTAGE_Formatado =
      PN_SUSPENDED_PERCENTAGE.toLocaleString("pt-BR", {
        minimumFractionDigits: 0,
        maximumFractionDigits: 0,
      });
    var PN_INPROGRESS_PERCENTAGE_Formatado =
      PN_INPROGRESS_PERCENTAGE.toLocaleString("pt-BR", {
        minimumFractionDigits: 0,
        maximumFractionDigits: 0,
      });
    ...
    slide14
      .getShapes()[147]
      .getText()
      .setText(PN_INPROGRESS_PERCENTAGE_Formatado + "%"); // Em andamento
    slide14
      .getShapes()[150]
      .getText()
      .setText(PN_SUSPENDED_PERCENTAGE_Formatado + "%"); // Suspensos
    ...
    var PN2_SUSPENDED_PERCENTAGE_Formatado =
      PN2_SUSPENDED_PERCENTAGE.toLocaleString("pt-BR", {
        minimumFractionDigits: 0,
        maximumFractionDigits: 0,
      });
    var PN2_INPROGRESS_PERCENTAGE_Formatado =
      PN2_INPROGRESS_PERCENTAGE.toLocaleString("pt-BR", {
        minimumFractionDigits: 0,
        maximumFractionDigits: 0,
      });
    ...
    slide14
      .getShapes()[40]
      .getText()
      .setText(PN2_INPROGRESS_PERCENTAGE_Formatado + "%"); // Em andamento
    slide14
      .getShapes()[43]
      .getText()
      .setText(PN2_SUSPENDED_PERCENTAGE_Formatado + "%"); // Suspensos
    ...
    var PA_SUSPENDED_PERCENTAGE_Formatado =
      PA_SUSPENDED_PERCENTAGE.toLocaleString("pt-BR", {
        minimumFractionDigits: 0,
        maximumFractionDigits: 0,
      });
    var PA_INPROGRESS_PERCENTAGE_Formatado =
      PA_INPROGRESS_PERCENTAGE.toLocaleString("pt-BR", {
        minimumFractionDigits: 0,
        maximumFractionDigits: 0,
      });
    ...
    slide14
      .getShapes()[46]
      .getText()
      .setText(PA_INPROGRESS_PERCENTAGE_Formatado + "%"); // Em andamento
    slide14
      .getShapes()[49]
      .getText()
      .setText(PA_SUSPENDED_PERCENTAGE_Formatado + "%"); // Suspensos
    ...
    slide14
      .getShapes()[203]
      .getText()
      .setText(PEP_ATINGIDO_NOVOS + "%"); // PEP - Atingido - Projetos Novos
    ...
    var newHeight_PEP_NOVOS = Math.min(
      (PEP_ATINGIDO_NOVOS / 100) * maxHeight_PEP_NOVOS + 0.000001,
      maxHeight_PEP_NOVOS
    );
    ...
    slide14
      .getShapes()[222]
      .getText()
      .setText(PEP_ATINGIDO_ANTIGOS + "%"); // PEP - Atingido - Projetos Antigos
    ...
    var newHeight_PEP_ANTIGOS = Math.min(
      (PEP_ATINGIDO_ANTIGOS / 100) * maxHeight_PEP_ANTIGOS + 0.000001,
      maxHeight_PEP_ANTIGOS
    );
    ...
    var newHeight_CRONOGRAMA = Math.min(
      (CRONOGRAMA / 100) * maxHeight_CRONOGRAMA + 0.000001,
    ...
    var newHeight_SINTONIA = Math.min(
      (SINTONIA / 100) * maxHeight_SINTONIA + 0.000001,
      maxHeight_SINTONIA
    );
    ...
    var newHeight_APONTAMENTO_HORAS = Math.min(
      (APONTAMENTO_HORAS / 100) * maxHeight_APONTAMENTO_HORAS + 0.000001,
    ...
    var newHeight_ESCOPO = Math.min(
      (ESCOPO / 100) * maxHeight_ESCOPO + 0.000001,
      maxHeight_ESCOPO
    );
    ...
    var newHeight_SIMULACAO = Math.min(
      (SIMULACAO / 100) * maxHeight_SIMULACAO + 0.000001,
      maxHeight_SIMULACAO
    );
    ...
    var newHeight_KICKOFF = Math.min(
      (KICKOFF / 100) * maxHeight_KICKOFF + 0.000001,
      maxHeight_KICKOFF
    );
    ...
    var newHeight_ENCERRAMENTO = Math.min(
      (ENCERRAMENTO / 100) * maxHeight_ENCERRAMENTO + 0.000001,
    ...
    slide14
      .getShapes()[195]
      .getText()
      .setText(DMP_ATINGIDO + "%"); // DMP - Atingido
    ...
    var newHeight_DMP = Math.min(
      (DMP_ATINGIDO / 20) * maxHeight_DMP + 0.000001,
      maxHeight_DMP
    );
    ...
    var newHeight_SAT_PN = Math.min(
      (SATISFAÇAO_ATINGIDO_PN / 100) * maxHeight_SAT_PN + 0.000001,
      maxHeight_SAT_PN
    );
    ...
    var newHeight_SAT_PA = Math.min(
      (SATISFAÇAO_ATINGIDO_PA / 100) * maxHeight_SAT_PA + 0.000001,
      maxHeight_SAT_PA
    );
    ...
    var VLR_MMR_Formatado =
      "R$ " +
      VLR_MMR.toLocaleString("pt-BR", {
    ...
    slide16
      .getShapes()[23]
      .getText()
      .setText(CL1_MMR + " mil"); // MMR por Cliente / Unidade (1)
    slide16
      .getShapes()[24]
      .getText()
      .setText(CL2_MMR + " mil"); // MMR por Cliente / Unidade (2)
    slide16
      .getShapes()[25]
      .getText()
      .setText(CL3_MMR + " mil"); // MMR por Cliente / Unidade (3)
    slide16
      .getShapes()[26]
      .getText()
      .setText(CL4_MMR + " mil"); // MMR por Cliente / Unidade (4)
    slide16
      .getShapes()[27]
      .getText()
      .setText(CL5_MMR + " mil"); // MMR por Cliente / Unidade (5)
