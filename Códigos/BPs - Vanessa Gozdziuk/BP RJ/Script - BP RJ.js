...
// Função para criar e inserir o Gráfico 1
...
// Função para criar e inserir o Gráfico 2
...
// Função para criar e inserir o Gráfico 3
...
function updateChartsRJ() {
  ...
  if (images.length >= 3) {
    ...
    const sheet =
      SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_BP_RJ);
...
// Função para atualizar informações da planilha para o slide
function updateBP_RJ() {
  try {
    ...
    // Atualizar as informações no slide
    ...
    slide34.getShapes()[42].getText().setText(PN2_TOTAL); // Total
