...
// Gráfico 1
function createChartBPNORTEMG1() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_BP_NORTEMG);
  ...
  insertChartBPNORTEMG(chart);
}

// Gráfico 2
function createChartBPNORTEMG2() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_BP_NORTEMG);
...
// Gráfico 3
function createChartBPNORTEMG3() {
  const sheet = SpreadsheetApp.openById(SHEETS_ID).getSheetByName(SHEET_BP_NORTEMG);
...
function insertChartBPNORTEMG(chart) {
  if (chart) { 
    const slides = SlidesApp.openById(SLIDES_ID);
    const slide = slides.getSlides()[slideIndex142];
